	...
	tutorialSidebar: [
			...
			items: [
				{
					...
					items: [
						...
						{ type: "doc", id: "smart-batch/async-queue", label: "Chamar endpoints como fila (async)" },
					],
				},
				{
					type: "category",
					...
					items: [
						...
						{ type: "doc", id: "check-list/check-list-api-companion", label: "Check List — Guia da API" },
						{ type: "doc", id: "check-list/list-all-check-lists", label: "Listar checklists" },
						{ type: "doc", id: "check-list/create-a-check-list", label: "Criar uma checklist" },
						{ type: "doc", id: "check-list/retrieve-a-check-list", label: "Obter uma checklist" },
						{ type: "doc", id: "check-list/update-a-check-list", label: "Atualizar uma checklist" },
						{ type: "doc", id: "check-list/delete-a-check-list", label: "Apagar uma checklist" },
					],
				},
				{ type: "doc", id: "smartenroll/smartenroll-api-companion", label: "SmartEnroll — Guia da API" },
			],
		},
		{
			type: "category",
			...
			items: [
				...
				{ type: "doc", id: "vehicle-validation/chile/vehicle-validation-chile-vehicle-stolen", label: "🇨🇱 Chile — Veículo roubado", key: "vehicle-chile-vehicle-stolen" },
				{
					...
					items: [
						...
						{ type: "doc", id: "vehicle-validation/colombia/vehicle-validation-colombia-runt-vehicle-by-plate-only", label: "🇨🇴 RUNT — veículo somente pela placa" },
		...
		},
		{
			...
			items: [
				...
				{ type: "doc", id: "background-check/colombia-police-record-check", label: "🇨🇴 Antecedentes na Polícia" },
