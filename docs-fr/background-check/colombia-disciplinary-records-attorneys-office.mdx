...
# Antécédents disciplinaires en Colombie (Procuraduría)
...
Ce service permet de consulter les antécédents disciplinaires des personnes en Colombie auprès de la Procuraduría General de la Nación (parquet général). En fournissant le type et le numéro de document, vous pouvez récupérer le nom de la personne ainsi que l'éventuelle existence d'antécédents disciplinaires. La réponse inclut le détail des sanctions, des instances, des délits et des inéligibilités associées au dossier.
...
| ---------------- | ------ | ------- | ---------------------------------------------------------------------------- |
| `documentType`   | string | **Oui** | Type de document. Valeurs autorisées : CC, PEP, CE.                          |
...
<Tabs>
<TabItem value="200-with-records" label="200 (Avec antécédents)">
...
<TabItem value="200-no-records" label="200 (Sans antécédents)">
...
<TabItem value="409-2" label="409 (Erreur serveur)">
