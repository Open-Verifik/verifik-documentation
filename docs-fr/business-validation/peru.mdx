---
id: peru
title: 🇵🇪 Pérou — Entreprise (RUC)
description: "Vérification d'entreprise au Pérou par RUC (v3/pe/company)."
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Vérification d'entreprise au Pérou (RUC) | API KYB Verifik",
	description:
		"Validez les sociétés péruviennes avec l'API KYB de Verifik. Connectez-vous aux sources officielles et vérifiez les données d'entreprise en quelques secondes.",
	articleSection: "Documentation API",
	keywords: "vérification d'entreprise, API KYB, validation RUC Pérou, vérification de société, source de données officielle, prévention de la fraude",
	about: {
		"@type": "Thing",
...
-   **Informations sur l'entreprise** : retourne la raison sociale, l'adresse, la condition du contribuable et le statut.
...
Interrogez une société péruvienne par **RUC** avec `documentType=RUC` et `documentNumber`. Retourne raison sociale, statut, adresse et situation fiscale à partir des registres officiels (KYB et due diligence).
...
Nous nous connectons directement aux sources officielles du gouvernement péruvien (SUNAT) afin de vous garantir des informations vérifiées et à jour.
