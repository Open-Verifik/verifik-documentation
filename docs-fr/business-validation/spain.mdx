---
id: spain
title: Entreprise espagnole (CIF/NIF)
...
Interroge une personne morale espagnole avec **`documentType`** (`CIF` ou `NIF`) et **`documentNumber`** (identifiant fiscal). Retourne des champs orientés registre pour le **KYB**, la **due diligence fournisseurs** et la **conformité**.
...
| ---------------- | ------ | ------- | ---------------------------------------------- |
| `documentType`   | string | **Oui** | Type de document (`CIF` ou `NIF`).             |
