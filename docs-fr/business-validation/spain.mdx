...
Interroge une personne morale espagnole avec **`documentNumber`** (identifiant fiscal d’entreprise, p. ex. CIF). Retourne des champs orientés registre pour le **KYB**, la **due diligence fournisseurs** et la **conformité**.
