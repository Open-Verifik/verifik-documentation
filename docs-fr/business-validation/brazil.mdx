...
title: Brésil — Vérification d'entreprise (CNPJ)
description: Vérifiez les entreprises brésiliennes au moyen du CNPJ avec l'API KYB Verifik et des données officielles.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Vérification d'entreprise au Brésil (CNPJ) | API KYB Verifik",
	description:
		"Validez les entreprises brésiliennes au moyen du CNPJ avec l'API KYB Verifik et des sources officielles.",
	articleSection: "Documentation API",
	keywords: "vérification d'entreprise, KYB API, CNPJ Brésil, conformité",
	about: {
		"@type": "Thing",
...
- `documentNumber` doit comporter 14 chiffres sans séparateurs.
