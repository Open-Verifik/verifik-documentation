...
description: Vérifiez le SOAT et la révision técnico-mécanica (RTM) d'un véhicule colombien en temps réel.
...
| ---------------- | ------ | -------- | ----------------------------------------------------------------------- |
| `documentType`   | string | Oui      | Type de document. Valeurs autorisées are: CC, CE, PA, RC, NIT.                 |
