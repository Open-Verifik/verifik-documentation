...
Le service des contraventions et amendes permet d'accéder à des informations détaillées sur les contraventions et amendes associées à un numéro de document donné en Colombie. La réponse inclut pour chaque contravention le type d'infraction, le montant de l'amende et le statut actuel.
