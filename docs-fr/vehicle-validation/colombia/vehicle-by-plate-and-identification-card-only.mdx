...
export const structuredData = {
	...
	keywords: "RUNT Colombia, vehicle validation, license plate query, VIN, Aseguradora, vehicle API, Colombia RUNT",
};
...
# Validation véhicule par plaque au RUNT
...
-   Assureur et type de polices (responsabilité civile contractuelle ou extracontractuelle, pas tous risques).
