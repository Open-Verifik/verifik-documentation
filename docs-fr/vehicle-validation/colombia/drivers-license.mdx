...
description: "Accédez aux données officielles du permis de conduire colombien : statut, catégories et dates d'expiration."
...
# Validation du permis de conduire au RUNT
...
| ---------------- | ------ | -------- | -------------------------------------------------------------- |
| `documentType`   | string | Oui      | Type de document. Valeurs autorisées: `CC`, `CE`, `PPT`, `PA`, `NIT`. |
