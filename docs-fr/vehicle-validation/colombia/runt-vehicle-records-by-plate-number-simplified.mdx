...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Simplified vehicle query by license plate in RUNT | Verifik API Colombia",
	description: "Query basic vehicle information in Colombia using the license plate. Simplified API for quick validation without owner data.",
	articleSection: "Documentation API",
	keywords: "RUNT Colombia, simplified vehicle query, license plate API, vehicle validation",
};
...
# Validation véhicule simplifiée par plaque au RUNT
...
| ---------------- | ------ | -------- | ----------------------------------------------------------------------- |
| `documentType`   | string | Oui      | Type de document. Valeurs autorisées: `CC`, `CE`, `PA`, `NIT`.               |
| `documentNumber` | string | Oui      | Numéro de document du propriétaire du véhicule, sans espaces ni points. |
| `plate`          | string | Oui      | Plaque du véhicule à consulter.                                               |
