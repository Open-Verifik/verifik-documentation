...
Ce service permet d'obtenir des informations détaillées sur les amendes et contraventions associées à un numéro de plaque d'immatriculation en Colombie. La réponse comprend des détails complets sur chaque contravention : type d'infraction, montant de l'amende et statut courant.
...
| --- | --- | --- | --- |
| `plate` | string | **Oui** | Plaque d'immatriculation à interroger, sans espaces ni points. |
...
- Ce service complet fournit l'ensemble des données SIMIT pour un véhicule : amendes, cours et accords de paiement.
- « Multas » contient les détails des infractions associées à la plaque du véhicule.
- « Cursos » liste les cours de sécurité routière liés aux infractions du véhicule.
