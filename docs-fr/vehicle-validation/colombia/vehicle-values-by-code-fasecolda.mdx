...
# Valeurs véhicule par code — Fasecolda
...
| -------------- | ------- | -------- | ---------------------------------------------- |
| `codeFasecolda` | string  | Oui      | Code Fasecolda identifiant le véhicule et ses caractéristiques. |
...
- Les montants sont en pesos colombiens (COP).
- `bcpp` field contains the base commercial price for the vehicle.
- **`estado: "USADO"`** : valeurs pour véhicule d'occasion.
