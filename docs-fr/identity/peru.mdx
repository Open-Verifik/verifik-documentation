...
Contrôle standard du **DNI péruvien (v3)** via le RENIEC : valide le **numéro de document** et renvoie les champs d’identité principaux. Utilisez `documentType=DNI` et un `documentNumber` à 8 chiffres.
