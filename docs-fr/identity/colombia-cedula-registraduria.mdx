...
export const structuredData = {
	...
	description:
		"Consultation directe SCCRC par document pour une CC colombienne — sans Procuraduría ni DIAN.",
...
Contrairement à [citoyen par document](/identity-validation/colombia/colombian-citizen) (`/v2/co/cedula`), cet endpoint interroge **uniquement la Registraduría** — il n’utilise **pas** Procuraduría ni DIAN.
