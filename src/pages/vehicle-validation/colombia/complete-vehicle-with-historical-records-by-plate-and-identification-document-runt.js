...
export default function OldGitBookRedirect() {
	...
	return (
		<Layout
			title="Complete Vehicle with Historical Records by Plate and Identification Document RUNT"
			description="RUNT complete vehicle history service with historical records"
		>
			<div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
				...
				<div style={{ marginTop: "2rem" }}>
					<h1>Complete Vehicle with Historical Records by Plate and Identification Document RUNT</h1>
...
print(r.json())`}</code>
					...
					<ul>
						...
						<li>This service includes complete historical records of all vehicle transactions and requests.</li>
