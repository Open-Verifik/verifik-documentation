...
export default function OldGitBookRedirect() {
	...
	const redirectUrl = "/business-validation/colombia-dian-verification";
		...
		>
			<div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
				...
				<div style={{ marginTop: "2rem" }}>
					<h1>Colombia - DIAN Verification</h1>
					...
					<table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "1.5rem" }}>
						...
						<tbody>
							<tr>
								...
								<td style={{ padding: "0.75rem", border: "1px solid #ddd" }}>
									Document type. Allowed parameter: <code>NIT</code>.
								</td>
							</tr>
							<tr>
								<td style={{ padding: "0.75rem", border: "1px solid #ddd" }}>
								...
								<td style={{ padding: "0.75rem", border: "1px solid #ddd" }}>Yes</td>
								<td style={{ padding: "0.75rem", border: "1px solid #ddd" }}>
									NIT (with or without verification digit).
								</td>
							</tr>
						</tbody>
					</table>
...
print(r.json())`}</code>
  ...
  "id": "5RCBO"
    ...
    "message": "Record not found."
					...
					<h3>Notes</h3>
					<ul>
						<li>Use clean NIT input; the service handles the verification digit.</li>
					</ul>
