	...
	tutorialSidebar: [
			...
			items: [
				...
				},
				{
					...
					items: [
						...
						{ type: "doc", id: "check-list/check-list-api-companion", label: "Check List API 指南" },
						{ type: "doc", id: "check-list/list-all-check-lists", label: "列出清单" },
						{ type: "doc", id: "check-list/create-a-check-list", label: "创建清单" },
						{ type: "doc", id: "check-list/retrieve-a-check-list", label: "获取清单" },
						{ type: "doc", id: "check-list/update-a-check-list", label: "更新清单" },
						{ type: "doc", id: "check-list/delete-a-check-list", label: "删除清单" },
					],
				},
		...
		},
		{
			...
			items: [
				...
				{ type: "doc", id: "vehicle-validation/chile/vehicle-validation-chile-vehicle-stolen", label: "🇨🇱 智利 — 被盗车辆", key: "vehicle-chile-vehicle-stolen" },
				{
					type: "category",
					label: "🇨🇴 Colombia",
					collapsible: true,
					items: [
						...
						{ type: "doc", id: "vehicle-validation/colombia/vehicle-validation-colombia-runt-vehicle-by-plate-only", label: "🇨🇴 RUNT — 仅凭车牌查询车辆" },
		...
		},
		{
			...
			items: [
				...
				{ type: "doc", id: "background-check/colombia-police-record-check", label: "🇨🇴 警方记录查询" },
