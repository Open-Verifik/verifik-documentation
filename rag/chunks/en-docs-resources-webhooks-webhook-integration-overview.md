---
id: "en-docs-resources-webhooks-webhook-integration-overview"
title: "Webhook Integration — Overview"
sourcePath: "docs/resources/webhooks/webhook-integration.mdx"
locale: "en"
category: "resources"
tags:
  - "resources"
...
Verifik sends JSON with **`type`** and **`object`** fields. See [Supported Events](/resources/supported-events) for the full list of `type` values and when they fire.
...
You will receive a public URL, such as `https://.ngrok.io`, which can be used by Verifik to send webhook events.
...
1. **Set Your Webhook URL**: Provide the public URL from ngrok to Verifik's integration team.
   * Example: `https://.ngrok.io/webhook`
