---
id: "es-docs-es-identity-validation-guatemala-notas-3"
title: "Ciudadano Guatemalteco — Notas"
...
- `dateOfBirth` es obligatorio y debe usar el formato **`DD/MM/YYYY`** (por ejemplo, `12/03/1984`).
