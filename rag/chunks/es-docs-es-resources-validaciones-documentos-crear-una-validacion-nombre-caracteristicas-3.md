---
id: "es-docs-es-resources-validaciones-documentos-crear-una-validacion-nombre-caracteristicas-3"
title: "Crear una Validación de Nombre — Características"
...
tags:
  ...
  - "resources"
endpoint: "/v2/document-validations/{id}/validate"
...
**API path(s):** /v2/document-validations/{id}/validate
