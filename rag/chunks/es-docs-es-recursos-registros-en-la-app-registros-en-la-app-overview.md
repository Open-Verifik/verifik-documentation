---
id: "es-docs-es-recursos-registros-en-la-app-registros-en-la-app-overview"
title: "Registros en la App — Overview"
...
# Registros en la App
**API path(s):** /v2/app-registrations, /v2/app-registrations/{id}, /v2/app-registrations/{id}/sync
