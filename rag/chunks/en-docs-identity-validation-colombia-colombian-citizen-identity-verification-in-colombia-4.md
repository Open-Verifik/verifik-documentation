---
id: "en-docs-identity-validation-colombia-colombian-citizen-identity-verification-in-colombia-4"
title: "Colombian Citizen — Identity Verification in Colombia"
...
endpoints:
  ...
  - "/v2/co/procuraduria"
sourceAnchor: "Identity Verification in Colombia"
...
-   **Full name & ID number**: *Cédula de Ciudadanía* (**CC**), *Cédula de Extranjería* (**CE**), *Permiso por Protección Temporal* (**PPT**), *Permiso Especial de Permanencia* (**PEP**), and *NIT*. Dedicated [Colombia CE](/identity/colombia-ce) remains available when you need expedition date / immigration status.
