---
id: "en-docs-vehicle-validation-colombia-fasecolda-sinister-verification-what-does-this-api-validate"
...
Check vehicle accident and insurance **claim** history from Fasecolda using the Colombia license **`plate`** as a **query** parameter (`?plate=`).
...
| --- | --- | --- | --- |
| `plate` | string | Yes | Vehicle plate to query, without spaces or periods. |
