---
id: "es-docs-es-validacion-vehiculos-colombia-consulta-general-por-documento-simit-endpoint"
title: "SIMIT - Consulta General por Documento de Identificación — Endpoint"
sourcePath: "docs-es/validacion-vehiculos/colombia/consulta-general-por-documento-simit.mdx"
locale: "es"
...
slug: "/validacion-vehiculos/colombia/consulta-general-por-documento-simit"
url: "https://docs.verifik.co/verifik-es/validacion-vehiculos/colombia/consulta-general-por-documento-simit"
---
...
El Servicio de Comparendos y Multas permite a los usuarios acceder a información detallada sobre comparendos y multas asociados con un número de documento específico en Colombia. La respuesta incluye detalles completos sobre cada comparendo, como el tipo de violación, el monto de la multa y el estado actual del comparendo.
...
| --- | --- | --- | --- |
| `documentType` | string | Yes | Tipo de documento. Parámetros válidos: `CC`, `PA`, `CE`, `TI`, `RC`, `NIT`. |
| `documentNumber` | string | Yes | Número de documento a ser consultado, sin espacios ni puntos. |
