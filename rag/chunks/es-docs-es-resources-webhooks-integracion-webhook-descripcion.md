---
id: "es-docs-es-resources-webhooks-integracion-webhook-descripcion"
title: "Integración de Webhooks — Descripción"
sourcePath: "docs-es/resources/webhooks/integracion-webhook.mdx"
locale: "es"
category: "resources"
tags:
  - "resources"
...
Verifik envía JSON con campos **`type`** y **`object`**. Consulta [Eventos soportados](/verifik-es/resources/eventos-soportados) para la lista completa de valores de `type` y cuándo se emiten.
...
Recibirás una URL pública, como `https://.ngrok.io`, que puede ser usada por Verifik para enviar eventos de webhook.
...
1. **Establece tu URL de Webhook**: Proporciona la URL pública de ngrok al equipo de integración de Verifik.
   * Ejemplo: `https://.ngrok.io/webhook`
