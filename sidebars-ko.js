	...
	tutorialSidebar: [
			...
			items: [
				...
				},
				{
					...
					items: [
						...
						{ type: "doc", id: "check-list/check-list-api-companion", label: "Check List API 가이드" },
						{ type: "doc", id: "check-list/list-all-check-lists", label: "체크리스트 목록" },
						{ type: "doc", id: "check-list/create-a-check-list", label: "체크리스트 만들기" },
						{ type: "doc", id: "check-list/retrieve-a-check-list", label: "체크리스트 조회" },
						{ type: "doc", id: "check-list/update-a-check-list", label: "체크리스트 수정" },
						{ type: "doc", id: "check-list/delete-a-check-list", label: "체크리스트 삭제" },
					],
				},
			...
			items: [
				...
				{ type: "doc", id: "vehicle-validation/chile/vehicle-validation-chile-vehicle-stolen", label: "🇨🇱 칠레 — 도난 차량", key: "vehicle-chile-vehicle-stolen" },
				{
					...
					items: [
						...
						{ type: "doc", id: "vehicle-validation/colombia/vehicle-validation-colombia-runt-vehicle-by-plate-only", label: "🇨🇴 RUNT — 번호판만 차량 조회" },
		...
		},
		{
			...
			items: [
				...
				{ type: "doc", id: "background-check/colombia-police-record-check", label: "🇨🇴 경찰 기록 조회" },
