	...
	tutorialSidebar: [
		{ type: "doc", id: "intro", label: "Accueil" },
		{
			...
			items: [
				...
				{ type: "doc", id: "identity/brazil", label: "🇧🇷 Brazil" },
		...
		},
		{
			...
			items: [
				...
				{ type: "doc", id: "business-validation/brazil", label: "🇧🇷 Brazil" },
			...
			items: [
				{
					...
					collapsible: true,
					items: [
						{ type: "doc", id: "vehicle-validation/argentina", label: "Aperçu" },
				...
				{ type: "doc", id: "vehicle-validation/brazil", label: "🇧🇷 Brazil" },
				...
				{ type: "doc", id: "vehicle-validation/chile/vehicle-validation-chile-vehicle-soap-plate", label: "🇨🇱 Chili — SOAP véhicule (par plaque)" },
				{
					type: "category",
					label: "🇨🇴 Colombia",
					collapsible: true,
				...
				{ type: "doc", id: "vehicle-validation/mexico", label: "🇲🇽 Mexico" },
