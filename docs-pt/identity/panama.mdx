...
description: Verifique dados nacionais panamenhos da CCPA (documento, nome, data de nascimento) contra fontes oficiais do registro civil para KYC e prevenção a fraudes.
...
export const structuredData = {
	...
	description:
		"Verifique dados nacionais panamenhos da CCPA (documento, nome, data de nascimento) contra fontes oficiais do registro civil para KYC e prevenção a fraudes.",
	articleSection: "Documentação da API",
	keywords: "verificação de identidade, API KYC, validação de CCPA Panamá, fonte de dados oficial, prevenção a fraudes",
	about: {
		"@type": "Thing",
...
Verifique dados da **CCPA** (*Cédula de Identidad Personal*) panamenha contra fontes oficiais do registro civil. Envie **`documentType`** (`CCPA`) e um **`documentNumber`** normalizado; a resposta confirma que o registro de identidade está consistente para **KYC**, onboarding de clientes e controles de fraude.
...
5. **Registro civil pré-2006 (AV)** — Província imediatamente seguida por `AV`. Exemplo: `10AV-1234-12345`
...
As regras de formato seguem o validador open source [cedula-panama](https://github.com/merlos/cedula-panama) (MIT).
