...
| `engineNumber` | string \| null | Número do motor quando disponível. |
| `chassis` | string \| null | Identificador do chassi quando disponível. |
...
- O serviço normaliza o formato da placa antes da consulta.
