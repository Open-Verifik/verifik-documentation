...
Este serviço permite obter multas e infrações associadas a uma placa na Colômbia. The response includes comprehensive details about each citation, such as the type of infraction, the fine amount, and the current status of the citation.
...
- Serviço SIMIT completo: multas, cursos e acordos de pagamento por veículo.
