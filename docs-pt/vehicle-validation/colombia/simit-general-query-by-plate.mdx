...
Este serviço permite obter informações detalhadas sobre multas e autuações associadas a um número de placa na Colômbia. A resposta inclui o tipo de infração, o valor da multa e o status atual de cada autuação.
...
- Este serviço completo fornece todos os dados SIMIT de um veículo, incluindo multas, cursos e acordos de pagamento.
- « Multas » contém detalhes das infrações associadas à placa do veículo.
- « Cursos » mostra cursos de educação no trânsito relacionados às infrações do veículo.
