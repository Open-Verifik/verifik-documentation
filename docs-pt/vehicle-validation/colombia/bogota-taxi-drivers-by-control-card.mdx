...
title: 🇨🇴 Bogotá - Taxi (cartão de controle)
description: Consulte informações do motorista de táxi e da carta de operação em Bogotá pelo número do cartão de controle.
sidebar_label: 🇨🇴 Bogotá - Taxi (cartão de controle)
keywords:
...
Este serviço retorna dados do motorista de táxi e da carta de operação em Bogotá pelo número do cartão de controle.
...
| --- | --- | --- | --- |
| `controlCardNumber` | string | Yes | Número do cartão de controle a consultar. |
