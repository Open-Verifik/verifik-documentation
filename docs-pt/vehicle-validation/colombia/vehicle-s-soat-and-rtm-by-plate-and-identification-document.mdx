...
description: Verifique SOAT e revisão técnico-mecânica (RTM) de veículos colombianos em tempo real.
...
| ---------------- | ------ | -------- | ----------------------------------------------------------------------- |
| `documentType`   | string | Sim      | Tipo de documento. Valores permitidos are: CC, CE, PA, RC, NIT.                 |
