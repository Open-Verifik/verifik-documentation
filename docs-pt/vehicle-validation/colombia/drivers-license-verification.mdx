...
description: Verifique status, categorias e validade da carteira de motorista colombiana via RUNT.
...
# Validação de carteira de motorista no RUNT
...
| ---------------- | ------ | -------- | -------------------------------------------------------------- |
| `documentType`   | string | Sim      | Tipo de documento. Valores permitidos: `CC`, `CE`, `PPT`, `PA`, `NIT`. |
