...
Passe **`includeCost=true`** em `/v2/co/cedula` para receber um objeto **`billing`** quando o preço dinâmico se aplicar. Consulte o [SLA — Preço dinâmico (faturamento)](/verifik-pt/legal/service-level-agreement#viiia-preço-dinâmico-faturamento).
