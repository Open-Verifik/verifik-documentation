...
slug: /pt-docs/background-check/colombia-disciplinary-records-attorneys-office
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Antecedentes disciplinares (Procuradoria)
...
Consulta antecedentes disciplinares na Procuradoria. Com tipo e número de documento, retorna identidade e detalhes de sanções, instâncias e inabilitações quando houver.
...
| ---------------- | ------ | ----------- | --------- |
| `documentType`   | string | Sim         | CC, PEP ou CE. |
