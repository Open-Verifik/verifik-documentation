...
title: Colômbia - Antecedentes disciplinares (Procuradoria)
description: Antecedentes disciplinares na Procuradoria Geral da Nação.
...
# Antecedentes disciplinares na Colômbia (Procuradoria)
...
O serviço verifica os antecedentes disciplinares de pessoas físicas na Colômbia (Procuradoria Geral / *Procuraduría*). Informando o tipo e o número do documento, é possível obter o nome da pessoa e se ela possui antecedentes disciplinares. A resposta inclui detalhes sobre sanções, instâncias, crimes e inabilitações associadas ao registro do indivíduo.
...
| ---------------- | ------ | ----------- | ------------------------------------------------------------------------- |
| `documentType`   | string | Sim         | Tipo de documento. Parâmetros permitidos: CC, PEP, CE.                    |
...
<Tabs>
<TabItem value="200-with-records" label="200 (Com antecedentes)">
...
<TabItem value="200-no-records" label="200 (Sem antecedentes)">
...
<TabItem value="409-2" label="409 (Erro do servidor)">
