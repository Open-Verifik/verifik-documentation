...
slug: /pt-docs/background-check/colombia-public-contracts
---
...
Recupera contratos públicos associados a uma pessoa ou empresa. A resposta inclui contratante, valores, entidades, prazos e outros detalhes.

Promove transparência e fiscalização de contratos com o Estado na Colômbia.
...
| ---------------- | ------ | ----------- | --------- |
| `documentType`   | string | Sim         | CC ou NIT. |
| `documentNumber` | string | Sim         | Número solicitado. |
