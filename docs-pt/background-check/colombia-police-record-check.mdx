...
slug: /pt-docs/background-check/colombia-police-record-check
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Antecedentes na Polícia Nacional
...
Verifica situação criminal e pendências perante autoridades judiciais (art. 248 da Constituição). Retorna nome e detalhes do status jurídico. Adequado para RH e diligência.
