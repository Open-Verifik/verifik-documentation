...
slug: /pt-docs/background-check/international/ofac-background-check
---
...
Consulte listas **OFAC SDN** com `documentType` e `documentNumber`, ou `fullName`. Para conformidade de sanções e triagem.
...
- **Conformidade de sanções.**
- **Mitigação de risco.**
- **KYC/AML** em banca e seguros.
...
- `foundInOFAC` e detalhes como `fullLink`.
