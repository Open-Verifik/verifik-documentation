...
slug: /pt-docs/background-check/international/dea-background-check
---
...
Consulte a lista de vigilância da **DEA** com `documentType` e `documentNumber`, ou `fullName`. Retorna indicador e, se aplicável, URL oficial.
...
- **Prevenção de riscos.**
- **KYC/AML** em saúde, farmacêutica, logística, finanças.
...
- Campos `foundInDEA` e `urlDEA` quando houver.
