...
title: 🇺🇸 Kansas (EUA) — Carteira de motorista
description: Valide uma carteira de motorista do Kansas (EUA) pelo número do documento, data de nascimento, nome e sobrenome — status, validade e credenciais.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Verificação de carteira de motorista no Kansas (EUA) | API Verifik",
	description:
		"Consulte uma carteira de motorista do Kansas pelo número da licença, data de nascimento, nome e sobrenome — status, restrições e dados da credencial.",
	articleSection: "Documentação da API",
	keywords: "Kansas, driver license, EUA, carteira de motorista, API Verifik",
	about: {
		"@type": "Thing",
...
```
  ...
  <TabItem value="409-2" label="409 (formato)">
