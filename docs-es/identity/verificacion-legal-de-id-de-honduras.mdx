---
id: verificacion-legal-de-id-de-honduras
title: Honduras
description: Verificar cédulas hondureñas usando DNIHN
slug: /honduras
---
...
Verificar identificación hondureña por `documentType=DNIHN` y `documentNumber`.
...
| --- | --- | --- | --- |
| `documentType` | string | Sí | Permitido: `DNIHN`. |
