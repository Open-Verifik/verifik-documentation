---
id: verificacion-legal-de-id-de-mexico
title: México
description: Verificar identidades de ciudadanos mexicanos usando CURP
slug: /mexico
---
...
Verificar CURP y retornar detalles clave de identidad.
...
| --- | --- | --- | --- |
| `documentType` | string | Sí | Permitido: `CURP`. |
| `documentNumber` | string | Sí | Valor CURP. |
