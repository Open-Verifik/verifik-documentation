...
description: "Verifica datos de cédula panameña (CCPA): documento y nombre frente a registros civiles oficiales para KYC y prevención de fraude."
...
export const structuredData = {
	...
	description:
		"Verifica datos de cédula panameña (CCPA): documento y nombre frente a registros civiles oficiales para KYC y prevención de fraude.",
...
Validación de identidad para personas en **Panamá** con la **CCPA** (*Cédula de Identidad Personal*). Envías **`documentType`** (`CCPA`), **`documentNumber`** normalizado; la API contrasta los datos con fuentes civiles oficiales. Pensada para **KYC**, onboarding y reducción de fraude en flujos totalmente automatizados por HTTPS.
