...
description: Valida la identidad de personas en Panamá con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.
...
export const structuredData = {
	...
	description:
		"Valida la identidad de personas en Panamá con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.",
...
| `documentNumber` | string | Sí      | Número de cédula. El formato depende del estatus de residencia:<br/>• **Ciudadanos**: Prefijo "8-" seguido de 4 dígitos, guión, y 4 dígitos<br/>• **Residentes Permanentes**: Prefijo "E-8-" seguido de 6 dígitos<br/>• **Residentes Temporales**: Prefijo "PE-" seguido de 8-9 dígitos |
...
- El formato del número de documento varía según el estatus de residencia:
  - **Ciudadanos**: Prefijo "8-" + 4 dígitos, guión, y 4 dígitos (ej., `8-1251-1829`)
  - **Residentes Permanentes**: Prefijo "E-8-" + 6 dígitos (ej., `E-8-197698`)
  - **Residentes Temporales**: Prefijo "PE-" + 8-9 dígitos (ej., `PE-12345678`)
...
Nos conectamos directamente con fuentes oficiales del gobierno panameño para asegurar que recibas información verificada y actualizada al minuto.
...
Nuestras APIs automatizan procesos de KYC, KYB, AML y validación biométrica, conectando empresas con fuentes oficiales de datos en Colombia, México, Perú, Chile, Uruguay, Argentina, Brasil, Panamá y más allá.
