...
description: Valida la identidad de personas en Paraguay con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Verificación de identidad en Paraguay | API de KYC Verifik",
	description:
		"Valida la identidad de personas en Paraguay con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.",
	articleSection: "Documentación API",
	keywords: "verificación de identidad, API KYC, validación identidad Paraguay, CIC Paraguay, prevención fraude",
	about: {
		"@type": "Thing",
