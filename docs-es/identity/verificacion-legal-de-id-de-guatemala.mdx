---
id: verificacion-legal-de-id-de-guatemala
title: Guatemala
description: Verificar identificaciones guatemaltecas usando CUI
slug: /guatemala
---
...
Verificar identificación guatemalteca por `documentType=CUI` y `documentNumber`.
...
| --- | --- | --- | --- |
| `documentType` | string | Sí | Permitido: `CUI`. |
