...
description: Valida la identidad de personas en Chile usando RUN con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.
...
export const structuredData = {
	...
	description:
		"Valida la identidad de personas en Chile usando RUN con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.",
...
-   **Nombre Completo y RUN**: Soporta *Rol Único Nacional* (RUN).
-   **Coincidencia de Identidad**: Verifica que el nombre proporcionado coincida con el número RUN.
...
| --- | --- | --- | --- |
| `documentType` | string | Sí | Valor permitido: `RUN`. |
| `documentNumber` | string | Sí | Valor RUN sin espacios ni separadores. |
...
-   Proporciona el RUN sin espacios o separadores.
