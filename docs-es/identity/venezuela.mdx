---
id: venezuela
title: Ciudadano venezolano (CCVE)
description: "Consulta de identidad nacional en Venezuela: verificación de cédula CCVE por número de documento mediante GET /v2/ve/cedula para KYC y prevención de fraude."
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Verificación de identidad nacional (CCVE) en Venezuela | API KYC Verifik",
	description:
		"Consulta de identidad para ciudadanos venezolanos: validación de datos de cédula (CCVE) por número de documento con el endpoint GET /v2/ve/cedula de Verifik.",
	articleSection: "Documentación API",
	keywords: "Venezuela CCVE, cédula nacional, verificación identidad, API KYC, v2/ve/cedula, prevención fraude",
	about: {
		"@type": "Thing",
...
# Verificación de identidad en Venezuela
...
| -------------- | ------- | -------- | ---------------------------------------------- |
| `documentNumber` | string | Sí      | Número de cédula nacional (CCVE). No se requiere `documentType` en la consulta: el servicio aplica **CCVE** en este endpoint. |
...
Nos conectamos directamente con fuentes oficiales del gobierno venezolano para asegurar que recibas información verificada y actualizada al minuto.
