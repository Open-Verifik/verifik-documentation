...
```json
{
  ...
  "signature": {
    "dateTime": "November 13, 2025 6:28 PM",
    "message": "Certified by Verifik.co"
  },
  "id": "X0L8V"
}
...
- Algunos campos pueden estar incluidos en la respuesta dependiendo de la disponibilidad de datos: `dateOfBirth`, `gender`, y `maritalStatus`. Estos campos no están garantizados en todas las respuestas.
- Cuando está presente, `dateOfBirth` sigue el formato `YYYY-MM-DD` (ejemplo: "1998-03-01").
