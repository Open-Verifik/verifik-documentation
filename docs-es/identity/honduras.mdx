...
description: Valida la identidad de personas en Honduras con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Verificación de identidad en Honduras | API de KYC Verifik",
	description:
		"Valida la identidad de personas en Honduras con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.",
	articleSection: "Documentación API",
	keywords: "verificación de identidad, API KYC, validación identidad Honduras, DNIHN Honduras, prevención fraude",
	about: {
		"@type": "Thing",
