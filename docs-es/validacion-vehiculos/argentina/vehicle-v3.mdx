...
| `engineNumber` | string \| null | Número de motor cuando esté disponible. |
| `chassis` | string \| null | Identificador de chasis cuando esté disponible. |
...
- El servicio normaliza el formato de la placa antes de la consulta.
