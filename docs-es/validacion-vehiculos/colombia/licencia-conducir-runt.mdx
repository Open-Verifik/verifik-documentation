...
title: Consulta de Licencia de Conducción por Cédula en RUNT (Premium) | Verifik API Colombia
description: Valida licencias de conducción en Colombia mediante el número de cédula. Omite primerApellido para pagar Premium (incluye consulta de nombre) o envíalo para pagar la tarifa Básica.
sidebar_label: RUNT - Licencia de Conducir (Premium)
...
# Validación de Licencia de Conducir en RUNT (Premium)
