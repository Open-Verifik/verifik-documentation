...
slug: /validacion-vehiculos/colombia/runt-placas
keywords:
...
export const structuredData = {
	...
	keywords: "RUNT Colombia, consulta por placa, API vehículos, GET /v2/co/runt/placas",
};
...
- El código AppFeature es **`colombia_api_runt_placas`**.
