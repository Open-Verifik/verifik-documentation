---
id: recuperar-un-webhook
title: Recuperar un Webhook
description: Recuperar un webhook específico usando su identificador único
slug: /recursos/recuperar-un-webhook
---
...
| ---- | ------ | -------- | ---------------------------------------------------------------- |
| `id` | string | Sí       | ID del webhook del que quieres traer la información.       |
...
- **Recuperación de Webhook Individual**: Obtener información detallada sobre un webhook específico
- **Configuración Completa**: Devuelve todas las configuraciones y metadatos del webhook
- **Múltiples Lenguajes de Programación**: Soporte para JavaScript, Python, PHP y Swift
- **Manejo de Errores**: Respuestas 404 apropiadas para webhooks inexistentes
- **Datos en Tiempo Real**: Acceder al estado actual y configuración del webhook
