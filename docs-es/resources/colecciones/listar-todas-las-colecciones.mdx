...
description: Obtén todas las colecciones generadas por un cliente específico. El único parámetro requerido es enviar el token de acceso. Con esto, Verifik identificará las colecciones generadas por este usuario.
