...
[ejemplo-de-acceso-por-email](/docs-es/acceso#ejemplo-de-acceso-por-correo)

* **Validación por Teléfono**

[ejemplo-de-acceso-por-telefono](/docs-es/acceso#ejemplo-de-acceso-por-teléfono)

* **Validación Biométrica**

[ejemplo-de-acceso-biometrico](/docs-es/acceso#ejemplo-de-acceso-biométrico)
...
| Ejemplo de Acceso por **Email** | | | [ejemplo-de-acceso-por-email](/docs-es/recursos/ejemplo-de-acceso-por-email) |
| Ejemplo de Acceso por **Teléfono** | | | [ejemplo-de-acceso-por-telefono](/docs-es/acceso#ejemplo-de-acceso-por-teléfono) |
| Ejemplo de Acceso por **Biometría** | | | [ejemplo-de-acceso-biometrico](/docs-es/acceso#ejemplo-de-acceso-biométrico) |
