...
slug: /recursos/el-objeto-persona
---
...
-   **Reconocimiento Facial**: Almacenar y gestionar individuos para reconocimiento facial
-   **Gestión de Imágenes**: Soporte para múltiples imágenes codificadas en Base64
-   **Organización de Colecciones**: Organizar personas en grupos usando colecciones
-   **Seguimiento de Estado**: Rastrear estado de persona (activo, inactivo, pendiente)
-   **Asociación de Cliente**: Vincular registros de persona a clientes específicos
-   **Codificación Automática**: Codificaciones faciales generadas automáticamente para reconocimiento
-   **Rastro de Auditoría**: Seguimiento completo de marcas de tiempo para todas las operaciones de persona
