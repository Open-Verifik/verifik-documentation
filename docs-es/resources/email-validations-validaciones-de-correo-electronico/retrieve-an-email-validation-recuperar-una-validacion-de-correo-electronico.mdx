---
id: retrieve-an-email-validation-recuperar-una-validacion-de-correo-electronico
title: Retrieve an Email Validation / Recuperar una Validación de Correo Electrónico
description: Recupera un registro específico de validación de email usando su identificador único
