...
También puedes encontrar el mismo registro con [Buscar una Persona por Nombre](/resources/lookup-a-person). Payloads de imagen muy cortos aún pueden devolver `412` con `"message": "only_images_in_base64"`.
