...
title: Retrieve a Phone Validation / Recuperar una Validación de Teléfono
description: Recupera un registro específico de validación de teléfono usando su identificador único
