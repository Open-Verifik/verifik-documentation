...
:::warning
El Token JWT que debes usar al crear `Validaciones Biométricas de Inicio de Sesión de Aplicación` es proporcionado por el [`Inicio de Sesión de Aplicación`](/verifik-es/resources/crear-un-inicio-sesion-aplicacion) en la creación.
:::
