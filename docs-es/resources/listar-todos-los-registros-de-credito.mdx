...
| ---------------- | ------ | --------- | ---------------------------------------------------------------------------------------------- |
| `page`           | number | No        | Especifica el número de página para paginación, comenzando desde 1.                            |
| `perPage`        | number | No        | Define el número de elementos por página para paginación.                                      |
