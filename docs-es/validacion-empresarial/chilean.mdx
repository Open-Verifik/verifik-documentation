...
| ---- | ---- | -------- | ----------- | ------- |
| `documentType` | string | **Yes** | Tipo de documento. Parámetro permitido: RUT. | `RUT` |
| `documentNumber` | string | **Yes** | RUT de la empresa que quieres consultar, ingresa este parámetro con puntos y guiones según lo establecido por la documentación nativa. | `33516727409` |
