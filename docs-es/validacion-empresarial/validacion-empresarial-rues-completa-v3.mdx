---
id: colombia-validacion-empresarial-rues-completa-v3
title: Colombia — RUES expediente completo (v3)
description: Expediente completo en RUES por NIT y categoría mediante GET /v3/co/rues-complete.
...
Recupera información empresarial completa del registro RUES de Colombia (mismos parámetros que `GET /v3/co/rues`, con más detalle en la respuesta).
...
- Para un **resumen** más ligero, usa **`GET /v3/co/rues`** ([Colombia — Consulta RUES (v3)](./colombia-rues-v3.mdx)).
