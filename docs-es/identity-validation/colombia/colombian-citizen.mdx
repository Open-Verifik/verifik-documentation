...
export const faqData = {
	...
	mainEntity: [
		...
		},
		{
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "La API soporta Cédula de Ciudadanía (CC), Cédula de Extranjería (CE), Permiso por Protección Temporal (PPT), Permiso Especial de Permanencia (PEP) y NIT.",
			},
		},
		{
			"@type": "Question",
...
<details>
  ...
  <div>
    La API soporta <strong>CC</strong>, <strong>CE</strong>, <strong>PPT</strong>, <strong>PEP</strong> y <strong>NIT</strong>.
  </div>
</details>
