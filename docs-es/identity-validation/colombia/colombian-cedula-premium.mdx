...
El **precio dinámico** aplica cuando llama al [**endpoint básico de cédula**](./colombian-citizen.mdx#dynamic-pricing) (`/v2/co/cedula`) y la Consulta Dinámica escala automáticamente a una ruta de verificación extendida. Si esa escalada devuelve **HTTP 200**, se cobra el mismo **nivel premium** que esta ruta, no el nivel estándar. Consulte el [SLA — Precio dinámico (facturación)](/verifik-es/acuerdo-de-niveles-de-servicio#viiia-precio-dinámico-facturación).
