---
id: guatemala-identity-validation
title: Ciudadano Guatemalteco
description: Valida la identidad de personas en Guatemala con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Verificación de identidad en Guatemala | API de KYC Verifik",
	description:
		"Valida la identidad de personas en Guatemala con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.",
	articleSection: "Documentación API",
	keywords: "verificación de identidad, API KYC, validación identidad Guatemala, CUI Guatemala, prevención fraude",
	about: {
		"@type": "Thing",
...
```php
<?php
$ch = curl_init("https://api.verifik.co/v2/gt/cedula");
