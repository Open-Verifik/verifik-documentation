---
id: chile-licencia-conducir
title: 🇨🇱 Chile - Licencia de Conducir
description: "Consulta licencia de conducir chilena por número: clase, restricciones, fechas de control, RUT y domicilio desde registros oficiales para flotas y cumplimiento."
...
Consulta la **licencia** por **`documentNumber`** (número de licencia). Suele devolver **RUT**, **clase**, **restricciones**, **fechas de control**, **comuna** y **dirección**, según el registro—útil para **flotas** y **RR.HH.** donde importa la **habilitación para conducir**.
