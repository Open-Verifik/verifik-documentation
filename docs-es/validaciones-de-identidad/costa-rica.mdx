---
id: costa-rica-validaciones-identidad
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Verificación de identidad en Costa Rica | API de KYC Verifik",
	description:
		"Valida la identidad de personas en Costa Rica con la API KYC de Verifik. Conecta con fuentes oficiales y verifica datos personales en segundos.",
