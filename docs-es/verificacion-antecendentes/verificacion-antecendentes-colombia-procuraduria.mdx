...
-   **Antecedentes Disciplinarios**: Verifica antecedentes disciplinarios en la Procuraduría General
-   **Información Detallada**: Detalles sobre sanciones, instancias, delitos e inhabilidades
-   **Certificación Oficial**: Certificados emitidos por la Procuraduría General de la Nación
