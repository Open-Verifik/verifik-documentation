...
FRONT
tail -n +15 docs/compensar/COMPENSAR_README.md >> docs/compensar/COMPENSAR_README.md.tmp
mv docs/compensar/COMPENSAR_README.md.tmp docs/compensar/COMPENSAR_README.md

# Fix COMPENSAR_EXECUTIVE_SUMMARY.md
...
FRONT
tail -n +15 docs/compensar/COMPENSAR_EXECUTIVE_SUMMARY.md >> docs/compensar/COMPENSAR_EXECUTIVE_SUMMARY.md.tmp
mv docs/compensar/COMPENSAR_EXECUTIVE_SUMMARY.md.tmp docs/compensar/COMPENSAR_EXECUTIVE_SUMMARY.md

# Fix COMPENSAR_PROPOSAL.md
...
FRONT
tail -n +15 docs/compensar/COMPENSAR_PROPOSAL.md >> docs/compensar/COMPENSAR_PROPOSAL.md.tmp
mv docs/compensar/COMPENSAR_PROPOSAL.md.tmp docs/compensar/COMPENSAR_PROPOSAL.md

# Fix COMPENSAR_COMPLIANCE_MATRIX.md
...
FRONT
tail -n +15 docs/compensar/COMPENSAR_COMPLIANCE_MATRIX.md >> docs/compensar/COMPENSAR_COMPLIANCE_MATRIX.md.tmp
mv docs/compensar/COMPENSAR_COMPLIANCE_MATRIX.md.tmp docs/compensar/COMPENSAR_COMPLIANCE_MATRIX.md

# Fix COMPENSAR_API_REFERENCE.md
...
FRONT
tail -n +15 docs/compensar/COMPENSAR_API_REFERENCE.md >> docs/compensar/COMPENSAR_API_REFERENCE.md.tmp
mv docs/compensar/COMPENSAR_API_REFERENCE.md.tmp docs/compensar/COMPENSAR_API_REFERENCE.md

# Fix COMPENSAR_FLOW_DIAGRAMS.md
...
FRONT
tail -n +15 docs/compensar/COMPENSAR_FLOW_DIAGRAMS.md >> docs/compensar/COMPENSAR_FLOW_DIAGRAMS.md.tmp
