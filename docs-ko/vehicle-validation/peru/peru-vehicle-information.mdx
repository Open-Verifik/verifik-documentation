...
title: 🇵🇪 페루 — 차량 정보
description: 페루 차량 정보 서비스는 차량 번호판을 기반으로 페루에 등록된 차량의 상세 데이터를 제공합니다. 응답에는 제조사, 모델, 연식, 엔진 및 차대 일련번호, 정원, 사용 유형 등 주요 정보가 포함됩니다.
...
페루 차량 정보 서비스는 번호판을 기반으로 페루에 등록된 차량의 상세 데이터를 제공합니다. 응답에는 제조사, 모델, 연식, 엔진 및 차대 일련번호, 정원, 사용 유형 등 주요 정보가 포함됩니다.
...
- **차량 검증**: 페루에 등록된 차량의 기본 정보를 검증합니다.
- **보험 서비스**: 보험 절차에 필요한 차량 데이터를 검증합니다.
- **교통 기관**: 공식 차량 정보를 조회합니다.
- **운수 기업**: 상용 차량 데이터를 검증합니다.
- **자산 검증**: 차량의 기술적 상세 정보를 확인합니다.
