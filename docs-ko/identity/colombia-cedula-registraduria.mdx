...
export const structuredData = {
	...
	description:
		"콜롬비아 CC에 대한 SCCRC 문서 직접 조회 — Procuraduría와 DIAN을 사용하지 않습니다.",
...
[문서 기반 시민 조회](/identity-validation/colombia/colombian-citizen)(` /v2/co/cedula`)와 달리, 이 엔드포인트는 **Registraduría만** 사용하며 Procuraduría와 DIAN을 시도하지 않습니다.
