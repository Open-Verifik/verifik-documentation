...
title: 콜롬비아 - 징계 기록 (검찰총장)
description: 콜롬비아 검찰총장(Procuraduría) 징계 기록 조회.
slug: /ko-docs/background-check/colombia-disciplinary-records-attorneys-office
---
...
개인의 징계 기록을 조회합니다. 제재·심급·죄명·자격 제한 정보가 포함될 수 있습니다.
...
| 이름             | 유형   | 필수 | 설명 |
| ---------------- | ------ | ---- | ---- |
| `documentType`   | string | 예   | CC, PEP 또는 CE. |
