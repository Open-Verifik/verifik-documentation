...
title: ユーロポール（Europol）身元照会
description: documentType・documentNumber または fullName で Europol の刑事記録をリアルタイム照会します。
slug: /ja-docs/background-check/international/europol-background-check
---
...
`documentType` と `documentNumber`、または `fullName` で Europol の刑事記録を照会します。一致がある場合は Europol 参照 URL が返ることがあります。
