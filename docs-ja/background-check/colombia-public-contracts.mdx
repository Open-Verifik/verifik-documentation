...
title: コロンビア - 公共契約
description: 個人または法人に紐づくコロンビアの公共契約一覧を取得します。
slug: /ja-docs/background-check/colombia-public-contracts
---
...
文書タイプと番号で、国家との公共契約の一覧を取得します。契約者、金額、関係機関、期間などが含まれます。
...
| 名前             | 種別   | 必須 | 説明 |
| ---------------- | ------ | ---- | ---- |
| `documentType`   | string | はい | CC または NIT。 |
| `documentNumber` | string | はい | 照会番号。 |
