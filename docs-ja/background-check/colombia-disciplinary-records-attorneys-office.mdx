...
title: コロンビア - 懲戒記録（検察総長）
description: コロンビア検察総長庁（Procuraduría）の懲戒記録照会。
slug: /ja-docs/background-check/colombia-disciplinary-records-attorneys-office
---
...
個人の懲戒記録を照会します。制裁・審級・罪状・資格制限などの情報が含まれる場合があります。
...
| 名前             | 種別   | 必須 | 説明 |
| ---------------- | ------ | ---- | ---- |
| `documentType`   | string | はい | CC、PEP または CE。 |
