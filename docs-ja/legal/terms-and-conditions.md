...
| ---------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| **Database Screening** | **サブスクリプション：** Basic、Plus、Business                          | <strong>PAYG：</strong> 12か月<br /><strong>サブスクリプション：</strong> 月次または年次 |
| **Biometrics**         | **ボリューム・コミットメント**                                               | **サブスクリプション：** 月次または年次                                                         |
| **zk Face Proofs**     | **ボリューム・コミットメント**                                               | **サブスクリプション：** 月次または年次                                                         |
| **smartCHECK**         | **PAYG**（従量課金） **サブスクリプション：** Basic、Plus、Business | <strong>PAYG：</strong> 12か月<br /><strong>サブスクリプション：</strong> 月次または年次 |
