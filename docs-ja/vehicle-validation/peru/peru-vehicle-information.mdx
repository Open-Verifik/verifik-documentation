...
title: 🇵🇪 ペルー — 車両情報（ナンバープレート）
description: ペルー車両情報サービスは、ナンバープレートに基づいて、ペルーで登録された車両に関する詳細情報を提供します。レスポンスには、メーカー、モデル、年式、エンジン番号、シャーシ製造番号、定員、用途種別などの主要情報が含まれます。
...
ペルー車両情報サービスは、ナンバープレートに基づいて、ペルーで登録された車両に関する詳細データを提供します。レスポンスには、メーカー、モデル、年式、エンジン番号、シャーシ製造番号、定員、用途種別などの主要情報が含まれます。
...
- **車両検証**: ペルーで登録された車両の基本情報を検証します。
- **保険サービス**: 保険プロセスのための車両データを検証します。
- **交通機関**: 車両に関する公式情報を照会します。
- **運送会社**: 商用車のデータを検証します。
- **資産検証**: 車両の技術的詳細を確認します。
