...
description: 文書番号別の SIMIT 包括的データ照会サービス。
sidebar_label: SIMIT - 身分証明書による一般照会
...
交通違反・罰金サービスを使用すると、コロンビアにおける特定の文書番号に紐づく交通違反および罰金の詳細情報にアクセスできます。レスポンスには、各交通違反の種別、罰金額、現在のステータスなどの包括的な詳細が含まれます。
