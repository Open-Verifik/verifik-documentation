...
title: SIMIT - 按身份证件综合查询
description: 按证件的 SIMIT 综合数据服务
sidebar_label: SIMIT - 按身份证件综合查询
...
交通罚款与处罚服务可让用户获取在哥伦比亚某特定证件号下的交通罚款与处罚详情。响应中包含每条罚款的完整信息，例如违章类型、罚款金额及罚款的当前状态。
