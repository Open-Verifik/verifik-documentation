...
本服务可获取哥伦比亚与特定机动车号牌相关的罚款及违章详细信息。响应包含每条违章的类型、罚款金额及当前状态。
...
- 本综合服务提供车辆全部 SIMIT 数据，包括罚款、培训课程与分期付款协议。
- 「Multas」包含与该车辆号牌相关的交通违章详情。
- 「Cursos」显示与车辆违章相关的交通安全教育课程。
