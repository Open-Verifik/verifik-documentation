...
| P2 | 179 | identity, biometrics, resources, etc. |
...
- `api/tags/preview-zelfproof`
  ...
  - `functions/preview-zelfproof.md`
...
- `v2/co/runt/vehiculo`
  ...
  - `vehicle-validation/colombia/runt-vehiculo.mdx`
...
| --- | --- | --- |
| P2 | `api/clients` | `api/accounts/create-account.md` |
| P2 | `api/clients/{id}` | `api/accounts/delete-account.md` |
| P2 | `api/clients/auth` | `api/accounts/authenticate.md` |
| P2 | `api/clients/sync` | `api/accounts/update-account.md` |
| P2 | `api/clients/sync/password` | `api/accounts/change-password.md` |
| P2 | `api/licenses` | `api/licenses/create-license.md` |
| P2 | `api/licenses/{licenseid}` | `api/licenses/delete-license.md` |
| P2 | `api/licenses/my-license` | `api/licenses/get-my-license.md` |
| P2 | `api/tags/decrypt` | `api/tags/decrypt-tag.md` |
| P2 | `api/tags/lease` | `api/tags/lease-tag.md` |
| P2 | `api/tags/lease-offline` | `api/tags/lease-offline.md` |
| P2 | `api/tags/lease-recovery` | `api/tags/lease-recovery.md` |
| P2 | `api/tags/preview` | `api/tags/preview-tag.md` |
| P2 | `api/tags/preview-zelfproof` | `api/tags/preview-zelfproof.md` |
| P2 | `api/tags/search` | `api/tags/search-tag.md` |
| P2 | `api/tags/search-by-domain` | `api/tags/search-by-domain.md` |
...
| P2 | `v2/co/policia/rnmc/premium` | `background-check/colombia-police-compliance-corrective-measures-premium.mdx` |
...
| P2 | `v2/co/rama/juzgado/expedientes` | `legal/colombia-judicial-records.mdx` |
...
| P1 | `v2/es/vehicle` | `vehicle-validation/spain.mdx` |
| P2 | `v2/europol` | `background-check/europol-background-check.mdx` |
...
| P2 | `v2/look-ups/phone` | `identity/phone-lookup.mdx` |
...
| P2 | `v2/ocr/scan-prompt/templates` | `ocr-engines/scan-prompt/list-of-scan-prompt-templates.mdx` |
| P2 | `v2/ofac` | `background-check/ofac-background-check.mdx` |
| P2 | `v2/onu` | `background-check/onu-background-check.mdx` |
...
| P1 | `v2/py/vehicle` | `vehicle-validation/paraguay.mdx` |
| P2 | `v2/sv/dui` | `identity/el-salvador.mdx` |
| P2 | `v2/usa/company` | `business-validation/united-states.mdx` |
| P2 | `v2/usa/florida/driver-license` | `driver-validation/florida-driver-license.md` |
| P2 | `v2/usa/kansas/driver-license` | `driver-validation/kansas-driver-license.md` |
| P2 | `v2/usa/ssn` | `identity-validation/united-states/ssn-verification-social-security-number.mdx` |
| P1 | `v2/usa/vehicle` | `vehicle-validation/united-states.mdx` |
| P1 | `v2/usa/vehicle-by-vin` | `vehicle-validation/united-states/vehicle-by-vin.mdx` |
...
| P2 | `v3/pe/company` | `business-validation/peru.mdx` |
...
- `identity/mexico-cedula-profesional.mdx`
- `identity/mexico-siged-certificado.mdx`
...
- `reference/endpoint-doc-index.md`
