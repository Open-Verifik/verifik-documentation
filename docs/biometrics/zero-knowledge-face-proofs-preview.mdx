...
description: Examine a HumanID to view its metadata and configuration without performing biometric verification
...
Also available as `POST /v2/zelf-proof/preview` (same handler).
