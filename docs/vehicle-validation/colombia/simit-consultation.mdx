...
description: SIMIT comprehensive data service
...
The SIMIT Consultation Service provides access to comprehensive traffic violation information for vehicles and drivers in Colombia.
