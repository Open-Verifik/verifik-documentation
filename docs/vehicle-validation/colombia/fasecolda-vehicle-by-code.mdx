...
title: Vehicle by Code
description: Fasecolda vehicle value service by code
...
The Fasecolda Vehicle Value Inquiry service provides comprehensive information about vehicles registered in Colombia using the Fasecolda code. You can access detailed data including vehicle class, brand, model, year, estimated value, load capacity, fuel type, and other key attributes.
