---
id: vehicle-validation-united-states-vehicle-information
...
slug: /vehicle-validation/united-states/vehicle-information
---
...
Retrieve U.S. vehicle details by license plate and state (NHTSA-backed decode). Use `plate` and `state` as query parameters.
