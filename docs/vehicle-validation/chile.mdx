---
id: chile
title: "\U0001F1E8\U0001F1F1 Chile - Vehicle Information"
...
- **Vehicle Information (`v2/cl/vehicle`)**: general vehicle registry data.
- **Vehicle Technical Review (`v3/cl/vehicle`)**: technical review status and inspection history. See [Chile - Vehicle Technical Review](/vehicle-validation/chile/vehicle-technical-review).
