...
description: Chilean vehicle validation service for retrieving vehicle information by license plate
...
For public transport by plate, see [Transport vehicle](./transport-vehicle) (`GET /v2/cl/transport-vehicle`).
