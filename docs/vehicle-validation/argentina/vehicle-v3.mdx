...
| `engineNumber` | string \| null | Engine number when available. |
| `chassis` | string \| null | Chassis identifier when available. |
...
- The service normalizes plate casing before lookup.
