...
| `force` | string | No | Set to `true` to bypass cache and fetch fresh data. | `true` |
...
- **Sandbox mode:** plates **`AB1001`**–**`AB1010`** and **`HTRT86`** return stable nested profiles; **`ERR404`** returns **404**.
