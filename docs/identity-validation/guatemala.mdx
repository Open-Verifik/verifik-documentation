---
id: identity-validation-guatemala
title: Guatemalan Citizen
description: Validate the identity of individuals in Guatemala with Verifik's KYC API. Connect with official sources and verify personal data in seconds.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Identity Verification in Guatemala | Verifik KYC API",
	description:
		"Validate the identity of individuals in Guatemala with Verifik's KYC API. Connect with official sources and verify personal data in seconds.",
	articleSection: "API Documentation",
	keywords: "identity verification, KYC API, Guatemala CUI validation, official data source, fraud prevention",
	about: {
		"@type": "Thing",
...
const { data } = await axios.get("https://api.verifik.co/v2/gt/cedula", {
  params: { documentType: "CUI", documentNumber: "3637187021206", dateOfBirth: "17/10/1982" },
...
func main() {
    url := "https://api.verifik.co/v2/gt/cedula?documentType=CUI&documentNumber=3637187021206&dateOfBirth=17/10/1982"
...
```json
{
  "data": {
    ...
    "fullName": "PEREZ PEREZ HUGO FELIX",
    "lastName": "HUGO FELIX"
  },
  "signature": {
    "dateTime": "May 15, 2026 3:36 PM",
