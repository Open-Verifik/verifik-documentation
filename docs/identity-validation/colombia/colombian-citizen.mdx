...
export const faqData = {
	...
	mainEntity: [
		...
		},
		{
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "The API supports Cédula de Ciudadanía (CC), Cédula de Extranjería (CE), Permiso por Protección Temporal (PPT), Permiso Especial de Permanencia (PEP), and NIT.",
			},
		},
		{
			"@type": "Question",
