...
The HTTP reference for Chile identity verification lives in **[Identity Verification in Chile](/identity/chile)**. This page defers to that guide so `AppFeature.docs` and internal tooling do not ingest duplicate endpoint definitions.
