...
description: Validate the identity of individuals in Chile using RUN with Verifik's KYC API. Connect with official sources and verify personal data in seconds.
...
export const structuredData = {
	...
	description:
		"Validate the identity of individuals in Chile using RUN with Verifik's KYC API. Connect with official sources and verify personal data in seconds.",
...
| --- | --- | --- | --- |
| `documentType` | string | Yes | Allowed values: `RUN` or `RUT`. Both refer to the same identification number. |
| `documentNumber` | string | Yes | RUN/RUT value without spaces or separators. |
