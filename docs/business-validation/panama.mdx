...
description: Validate Panamanian companies with Verifik's KYB API. Connect with official sources and verify business data in seconds.
...
export const structuredData = {
	...
	description:
		"Validate Panamanian companies with Verifik's KYB API. Connect with official sources and verify business data in seconds.",
