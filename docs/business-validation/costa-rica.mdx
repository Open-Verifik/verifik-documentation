---
id: costa-rica
title: Costa Rican Business Verification (NITE)
description: KYB company lookup for Costa Rica via GET /v2/cr/company with documentType NITE and documentNumber for registration and compliance.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Costa Rica company verification (NITE) | Verifik KYB API",
	description:
		"Verify Costa Rican companies using NITE: GET /v2/cr/company with documentType and documentNumber for KYB and vendor due diligence.",
	articleSection: "API Documentation",
	keywords: "business verification, KYB API, Costa Rica NITE validation, company verification, official data source, fraud prevention",
	about: {
		"@type": "Thing",
...
# Business Verification in Costa Rica
