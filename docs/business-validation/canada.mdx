...
description: Validate Canadian companies with Verifik's KYB API. Connect with official sources and verify business data in seconds.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Business Verification in Canada | Verifik KYB API",
	description:
		"Validate Canadian companies with Verifik's KYB API. Connect with official sources and verify business data in seconds.",
	articleSection: "API Documentation",
	keywords: "business verification, KYB API, Canada company validation, business registry, company verification, official data source, fraud prevention",
	about: {
		"@type": "Thing",
...
# Business Verification in Canada
