...
id: panama
title: Panama
description: Verify identities of Panamanian citizens using CCPA (Personal Identity Card)
...
Validate identity for Panamanian citizens and permanent residents via Personal Identity Card.
