...
description: 'Verify Panamanian CCPA national ID data (document and name) against official civil-registry sources for KYC and fraud prevention.'
...
export const structuredData = {
	...
	description:
		"Verify Panamanian CCPA national ID data (document and name) against official civil-registry sources for KYC and fraud prevention.",
...
Verify Panamanian **CCPA** (*Cédula de Identidad Personal*) data against official civil-registry sources. Send **`documentType`** (`CCPA`) and a normalized **`documentNumber`**; the response confirms that the identity record is consistent for **KYC**, customer onboarding, and fraud controls.
