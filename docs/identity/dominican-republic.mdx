...
description: Verify Dominican identities using CIE
...
Verify Dominican identification by `documentType=CIE` and `documentNumber`.
...
| --- | --- | --- | --- |
| `documentType` | string | Yes | Allowed: `CIE`. |
