...
title: Dominican Citizen
description: Validate the identity of individuals in the Dominican Republic with Verifik's KYC API. Connect with official sources and verify personal data in seconds.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Identity Verification in Dominican Republic | Verifik KYC API",
	description:
		"Validate the identity of individuals in the Dominican Republic with Verifik's KYC API. Connect with official sources and verify personal data in seconds.",
	articleSection: "API Documentation",
	keywords: "identity verification, KYC API, Dominican Republic CIE validation, official data source, fraud prevention",
	about: {
		"@type": "Thing",
