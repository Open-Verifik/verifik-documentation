...
id: venezuela
title: Venezuela
description: Verify Venezuelan identifications by document number
...
Verify Venezuelan identification by `documentNumber`.
...
- Some fields may be included in the response depending on data availability: `dateOfBirth`, `gender`, and `maritalStatus`. These fields are not guaranteed to be present in all responses.
- When present, `dateOfBirth` follows the format `YYYY-MM-DD` (e.g., "1998-03-01").
