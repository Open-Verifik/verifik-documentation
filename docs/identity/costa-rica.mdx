...
description: Validate the identity of individuals in Costa Rica with Verifik's KYC API. Connect with official sources and verify personal data in seconds.
...
export const structuredData = {
	...
	"@type": "TechArticle",
	headline: "Identity Verification in Costa Rica | Verifik KYC API",
	description:
		"Validate the identity of individuals in Costa Rica with Verifik's KYC API. Connect with official sources and verify personal data in seconds.",
