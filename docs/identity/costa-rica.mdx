...
id: costa-rica
title: Costa Rica
description: Verify identities of Costa Rican citizens using CCCR (Cedula)
...
Verify Costa Rican Cedula and return identity details.
...
| --- | --- | --- | --- |
| `documentType` | string | Yes | Allowed: `CCCR`. |
