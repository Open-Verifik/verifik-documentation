---
id: legal-verification-for-chilean-id
title: Chile
description: Verificar identidades de ciudadanos chilenos usando RUN (Rol Único Nacional)
slug: /chile
---
...
Verificar RUN y retornar detalles clave de identidad.
...
- Proporciona RUN sin espacios o separadores.
